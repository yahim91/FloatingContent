...
architecture. The cities we considered are: SanFrancisco, Beijing and Berlin.
...
imported and how the resulting SUMO-network is generated. We are removing
isolated edges because they have no influence and benefit for the simulation
scenario. We also remove the unnecessary nodes that split edges without being at
a junction. We cluster junctions with traffic lights and join the traffic light
logic.
