...
Connectivity modelling is a more difficult to be designed in wireless networks
than in the wired one. In the latter case, connectivity is achieved with wires
...
by one connection, because is a broadcast medium.
